...
- **Dev Server URL**: `http://127.0.0.1:5195`
...
3. The dev server is accessible at `http://127.0.0.1:5195`
4. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/c91b2748-e03b-4789-8482-511c41d584db/preview`
