      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Transform your space with our expert cleaning solutions. Residential, commercial, and specialized cleaning services tailored to your needs.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-gray-600 mb-6">Complete home cleaning services including deep cleaning, regular maintenance, and move-in/move-out cleaning.</p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-gray-600 mb-6">Professional office and commercial space cleaning to maintain a healthy work environment.</p>
              <ul className="space-y-2 text-gray-600">
                <li>• Office Spaces</li>
                <li>• Retail Stores</li>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition">
              ...
              <h3 className="text-2xl font-semibold mb-4">Specialized Services</h3>
              <p className="text-gray-600 mb-6">Customized cleaning solutions including post-construction, carpet cleaning, and window washing.</p>
              <ul className="space-y-2 text-gray-600">
      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Why Choose SparkleClean?</h2>
              <p className="text-lg text-gray-600 mb-6">
                With over 10 years of experience, we've built a reputation for excellence, reliability, and attention to detail. Our team of trained professionals uses eco-friendly products and state-of-the-art equipment to deliver exceptional results every time.
              </p>
      ...
      <section id="contact" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Contact us today for a personalized cleaning solution</p>
          </div>
